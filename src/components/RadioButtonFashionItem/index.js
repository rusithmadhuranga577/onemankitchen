...
class RadioButtonFashionItem extends React.Component {
                        ...
                        >
                            <View style={styles.leftProductBox}>
                                <View style={[styles.circle, {
                                    borderColor: activeIndex === index ? Colors.white : 'red',
                                    alignItems : 'center',
...
/* Props ======================================= */
RadioButtonFashionItem.propTypes = {
...
RadioButtonFashionItem.defaultProps = {
	style: {},
	boxStyle: {},
	textStyle: {},
    initial: -1,
...
/* Export Component ============================ */
export default RadioButtonFashionItem;