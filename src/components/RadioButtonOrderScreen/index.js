...
import { Colors, Constants, Icons , Languages } from '@common';
            ...
            <View style={style}>
            {
                data.map((item, index) => {
                    return (
                        <TouchableOpacity
                            key={index}
                            style={[styles.productBoxLess, {backgroundColor : activeIndex === index ? Colors.gray : Colors.white}]}
                            activeOpacity={0.9}
                        ...
                        >
                                ...
                                icon && {
                                    ...
                                    <Animated.View style={{
                                        ...
                                        <Icon
                                            ...
                                            color={activeIndex === index ? Colors.primary : 'transparent'}
                                        /> 
                                        </Animated.View>
                                    </Animated.View>
                                </View>
                            ...
                            <View style={[styles.rightProductBox]}>
                                {item.label == 'Card Payment' ? 
                                <View style={{width : 70, height : 30, alignItems : 'center', height : '100%', justifyContent : 'center'}}>
                                    <Image source={Icons.cardpayment} style={{width : 90, height : 20, justifyContent : 'center'}}/>
                                </View>
                                :
